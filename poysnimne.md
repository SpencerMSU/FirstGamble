...
## Грави-драйв (`ludka/gravirun_logic.cpp`)
...
- **Использование:** передавайте текущее состояние (позиции объектов, таймер спавна, очки, жизни, буст) и дельту времени. Это ровно та логика, которую вызывает `gravirun_logic_adapter.js` из `minigames/gravidrive.html`.
